...
const MyAvatar = () => {
    return (
        <div className="relative flex items-center justify-center w-[300px] h-[300px] lg:w-[360px] lg:h-[550px] overflow-visible ">
            ...
            <Canvas className="w-[320px] h-[320px] lg:w-[360px] lg:h-[360px] overflow-visible">
